...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.println("Routes Orientation of Heruistic/Hill Climbing Method");
        mTSP.print(params.getVerbose());
        int secondCost=mTSP.cost();
        System.out.println("**Total cost after applying Hill climbing is :" + mTSP.cost());
        ...
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.println("Routes Orientation of Simulated Annealing Method");
        // Run simulated annealing
        SimulatedAnnealing saSolver = new SimulatedAnnealing(mTSP);
        saSolver.simulatedAnnealing(args,secondCost,TurkishNetwork.distance, initialTemperature, coolingRate);
